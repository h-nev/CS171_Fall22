...
class Awards{
    ...
    initVis(){
        ...
        //     })
        //     .attr('fill', 'white')
        //     .attr('transform', `translate(${vis.margin.spacing + vis.margin.padding}, 0) scale(0.2, 0.2)`);
    ...
    calculate(){
        ...
        vis.height = Math.ceil(vis.baseData.length / Math.floor(vis.width / (vis.margin.spacing + vis.margin.padding))) * (vis.margin.spacing + vis.margin.padding)
    ...
    preProcess(){
        ...
        // Change the displayData to have all the right data types
        vis.displayData = vis.baseData.map(function (element) {
            return {
                award: element['Award'],
                year: +element['Year'],
    ...
    wrangleData(){
        ...
        // Nothing to do at the moment (no filtering applied for now)
